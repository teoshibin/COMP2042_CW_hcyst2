...
public class Level_005 implements LevelBase {
    ...
    public void loadLevel() {
        ...
        LoadComponents.addMediumLog(-50, ConstantData.LAYOUT_Y_ACTOR[0][2], 1.5);
        LoadComponents.addTurtle(250, ConstantData.LAYOUT_Y_ACTOR[0][2], 1.5);
        LoadComponents.addWetTurtle(450, ConstantData.LAYOUT_Y_ACTOR[0][2], 1.5);
        LoadComponents.addWetTurtle(650, ConstantData.LAYOUT_Y_ACTOR[0][2], 1.5);

        LoadComponents.addShortLog(-100, ConstantData.LAYOUT_Y_ACTOR[0][3], 2.25);
        LoadComponents.addMediumLog(450, ConstantData.LAYOUT_Y_ACTOR[0][3], 2.25);
        LoadComponents.addWetTurtle(800, ConstantData.LAYOUT_Y_ACTOR[0][3], 2.25);

        LoadComponents.addWetTurtle(-100, ConstantData.LAYOUT_Y_ACTOR[0][4], -1.25);
        LoadComponents.addWetTurtle(350, ConstantData.LAYOUT_Y_ACTOR[0][4], -1.25);
        LoadComponents.addWetTurtle(650, ConstantData.LAYOUT_Y_ACTOR[0][4], -1.25);

        LoadComponents.addShortLog(-200, ConstantData.LAYOUT_Y_ACTOR[0][5], 1.75);
        LoadComponents.addWetTurtle(0, ConstantData.LAYOUT_Y_ACTOR[0][5], 1.75);
        LoadComponents.addShortLog(300, ConstantData.LAYOUT_Y_ACTOR[0][5], 1.75);
        LoadComponents.addWetTurtle(600, ConstantData.LAYOUT_Y_ACTOR[0][5], 1.75);
        // RIVER 5
        // GRASS 6
        // ROAD 7
        LoadComponents.addCar(-150, ConstantData.LAYOUT_Y_ACTOR[0][7], -2);
        LoadComponents.addShortTruck(50, ConstantData.LAYOUT_Y_ACTOR[0][7], -2);
        LoadComponents.addShortTruck(200, ConstantData.LAYOUT_Y_ACTOR[0][7], -2);
        LoadComponents.addCar(580, ConstantData.LAYOUT_Y_ACTOR[0][7], -2);
        LoadComponents.addLongTruck(780, ConstantData.LAYOUT_Y_ACTOR[0][7], -2);
        ...
        LoadComponents.addLongTruck(560, ConstantData.LAYOUT_Y_ACTOR[0][9], -1.5);
        ...
        LoadComponents.addLongTruck(450, ConstantData.LAYOUT_Y_ACTOR[0][10], 1.5);
