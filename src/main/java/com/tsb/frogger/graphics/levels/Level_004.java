...
public class Level_004 implements LevelBase {
    ...
    public ActorLoader loadLevel(ActorLoader al) {
        ...
        al.addMediumLog(300, ConstantData.LAYOUT_Y_ACTOR[0][3], -2.25);
        al.addWetTurtle(800, ConstantData.LAYOUT_Y_ACTOR[0][3], -2.25);

        al.addTurtle(-100, ConstantData.LAYOUT_Y_ACTOR[0][4], 1.25);
        al.addShortLog(350, ConstantData.LAYOUT_Y_ACTOR[0][4], 1.25);
        al.addShortLog(650, ConstantData.LAYOUT_Y_ACTOR[0][4], 1.25);

        al.addWetTurtle(-200, ConstantData.LAYOUT_Y_ACTOR[0][5], -1.5);
        al.addWetTurtle(0, ConstantData.LAYOUT_Y_ACTOR[0][5], -1.5);
        al.addShortLog(300, ConstantData.LAYOUT_Y_ACTOR[0][5], -1.5);
        al.addWetTurtle(600, ConstantData.LAYOUT_Y_ACTOR[0][5], -1.5);
        // RIVER 5
        // GRASS 6
        // ROAD 7
        al.addCar(-150, ConstantData.LAYOUT_Y_ACTOR[0][7], 1.75);
        al.addShortTruck(50, ConstantData.LAYOUT_Y_ACTOR[0][7], 1.75);
        al.addShortTruck(200, ConstantData.LAYOUT_Y_ACTOR[0][7], 1.75);
        al.addCar(580, ConstantData.LAYOUT_Y_ACTOR[0][7], 1.75);
        al.addLongTruck(780, ConstantData.LAYOUT_Y_ACTOR[0][7], 1.75);
        ...
        al.addCar(770, ConstantData.LAYOUT_Y_ACTOR[0][9], -1.5);

        al.addCar(-200, ConstantData.LAYOUT_Y_ACTOR[0][10], 1.5);
        al.addCar(160, ConstantData.LAYOUT_Y_ACTOR[0][10], 1.5);
        al.addShortTruck(450, ConstantData.LAYOUT_Y_ACTOR[0][10], 1.5);
