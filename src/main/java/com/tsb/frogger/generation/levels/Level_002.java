...
public class Level_002 implements LevelBase{
    ...
    public ActorLoader loadLevel(ActorLoader al) {
        ...
        // END 0
        // RIVER 1
        al.addMediumLog(0, ConstantData.LAYOUT_Y_ACTOR[0][1], 1);
        al.addLongLog(300, ConstantData.LAYOUT_Y_ACTOR[0][1], 1);
        al.addMediumLog(700, ConstantData.LAYOUT_Y_ACTOR[0][1], 1);

        al.addMediumLog(-50, ConstantData.LAYOUT_Y_ACTOR[0][2], -1.25);
        al.addTurtle(250, ConstantData.LAYOUT_Y_ACTOR[0][2], -1.25);
        al.addTurtle(450, ConstantData.LAYOUT_Y_ACTOR[0][2], -1.25);
        ...
        al.addMediumLog(800, ConstantData.LAYOUT_Y_ACTOR[0][3], -2);

        al.addTurtle(-100, ConstantData.LAYOUT_Y_ACTOR[0][4], 1);
        al.addMediumLog(350, ConstantData.LAYOUT_Y_ACTOR[0][4], 1);
        al.addMediumLog(650, ConstantData.LAYOUT_Y_ACTOR[0][4], 1);

        al.addTurtle(-200, ConstantData.LAYOUT_Y_ACTOR[0][5], -1.25);
        al.addWetTurtle(0, ConstantData.LAYOUT_Y_ACTOR[0][5], -1.25);
        al.addMediumLog(300, ConstantData.LAYOUT_Y_ACTOR[0][5], -1.25);
        al.addWetTurtle(600, ConstantData.LAYOUT_Y_ACTOR[0][5], -1.25);
        // RIVER 5
        // GRASS 6
        // ROAD 7
        ...
        al.addCar(-160, ConstantData.LAYOUT_Y_ACTOR[0][8], -1.5);
        al.addCar(320, ConstantData.LAYOUT_Y_ACTOR[0][8], -1.5);
        al.addCar( 660, ConstantData.LAYOUT_Y_ACTOR[0][8], -1.5);
        ...
        al.addCar(-200, ConstantData.LAYOUT_Y_ACTOR[0][10], 1);
        al.addCar(160, ConstantData.LAYOUT_Y_ACTOR[0][10], 1);
        al.addCar(450, ConstantData.LAYOUT_Y_ACTOR[0][10], 1);
        al.addCar(780, ConstantData.LAYOUT_Y_ACTOR[0][10], 1);
