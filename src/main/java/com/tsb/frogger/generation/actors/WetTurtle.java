...
public class WetTurtle extends ActingActor implements AnimatingActor{
	...
	public WetTurtle(int layoutX, int layoutY, double s, int w, int h) {
		...
		Image turtle1 = new Image(ad.getExternal("image.actor.wetTurtle.1"), w, h, true, true);
		Image turtle2 = new Image(ad.getExternal("image.actor.wetTurtle.2"), w, h, true, true);
		Image turtle3 = new Image(ad.getExternal("image.actor.wetTurtle.3"), w, h, true, true);
		Image turtle4 = new Image(ad.getExternal("image.actor.wetTurtle.4"), w, h, true, true);
